...
def test_nv_embed_model_id_and_dimensions():
    with patch("muse.modalities.embedding_text.backends.nv_embed_v2.AutoModel") as mock_cls:
        mock_cls.from_pretrained.return_value = _mock_model()
        from muse.modalities.embedding_text.backends.nv_embed_v2 import NVEmbedV2Backend
