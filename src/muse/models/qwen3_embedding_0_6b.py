"""Qwen3-Embedding-0.6B: 1024 dims (matryoshka), 32K context, Apache 2.0.

Based on the Qwen3 backbone; drop-in compatible with sentence-transformers
(``trust_remote_code=True`` required because the architecture is published
inside the HF repo).
...
class Model:
    ...
    ``from muse.models.qwen3_embedding_0_6b import Model as Qwen3Embedding06BBackend``
    for readability.
    """
